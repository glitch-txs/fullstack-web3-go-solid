...
// MaxAddress is a free data retrieval call binding the contract method 0xbfcaaf7a.
//
// Solidity: function maxAddress() view returns(uint256)
func (_ERC20 *ERC20Caller) MaxAddress(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _ERC20.contract.Call(opts, &out, "maxAddress")
...
//
// Solidity: function maxAddress() view returns(uint256)
func (_ERC20 *ERC20Session) MaxAddress() (*big.Int, error) {
	return _ERC20.Contract.MaxAddress(&_ERC20.CallOpts)
}

// MaxAddress is a free data retrieval call binding the contract method 0xbfcaaf7a.
//
// Solidity: function maxAddress() view returns(uint256)
func (_ERC20 *ERC20CallerSession) MaxAddress() (*big.Int, error) {
	return _ERC20.Contract.MaxAddress(&_ERC20.CallOpts)
}
...
//
// Solidity: function minted(address ) view returns(uint256)
func (_ERC20 *ERC20Caller) Minted(opts *bind.CallOpts, arg0 common.Address) (*big.Int, error) {
	var out []interface{}
	err := _ERC20.contract.Call(opts, &out, "minted", arg0)
...
//
// Solidity: function minted(address ) view returns(uint256)
func (_ERC20 *ERC20Session) Minted(arg0 common.Address) (*big.Int, error) {
	return _ERC20.Contract.Minted(&_ERC20.CallOpts, arg0)
}

// Minted is a free data retrieval call binding the contract method 0x1e7269c5.
//
// Solidity: function minted(address ) view returns(uint256)
func (_ERC20 *ERC20CallerSession) Minted(arg0 common.Address) (*big.Int, error) {
	return _ERC20.Contract.Minted(&_ERC20.CallOpts, arg0)
}
